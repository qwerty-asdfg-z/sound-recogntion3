...
function gotResults(error,results){
    if(error) {
        ...
        document.getElementById("result_label").innerHTML=' Voice heard'+
    results[0].label;
...
if(results[0].label =="Dogs")
{
    img.src="dog.gif"
    dog=dog+1
    document.getElementById("result_confidence").innerHTML=' Detected Times:'+
    dog
...
{
    img.src="hearing-aid-simpsons.gif"}
}
}
